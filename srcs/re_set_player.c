...
/*   Updated: 2024/09/13 17:04:12 by apple            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_player(t_game *game)
{
	...
	if (game->player.is_moving)
	{
		...
		game->player.pos.x += game->player.dir.x * game->player.is_moving * PLAYER_HALF_ROTATE;
		if (game->map_str[(int)game->player.pos.y][(int)game->player.pos.x] == '1')
			game->player.pos.x = old_pos_x;
		old_pos_y = game->player.pos.y;
		game->player.pos.y += game->player.dir.y * game->player.is_moving * PLAYER_HALF_ROTATE;
		if (game->map_str[(int)game->player.pos.y][(int)game->player.pos.x] == '1')
...
void	slide_player(t_game *game)
{
	...
	{
		old_pos_x = game->player.pos.x;
		game->player.pos.x += game->player.dir.y * game->player.is_sidling * PLAYER_HALF_ROTATE;
		if (game->map_str[(int)game->player.pos.y][(int)game->player.pos.x] == '1')
			game->player.pos.x = old_pos_x;
		old_pos_y = game->player.pos.y;
		game->player.pos.y -= game->player.dir.x * game->player.is_sidling * PLAYER_HALF_ROTATE;
		if (game->map_str[(int)game->player.pos.y][(int)game->player.pos.x] == '1')
			game->player.pos.y = old_pos_y;
	}
}
